...
function sys = mdlOutputs(t,u,s, plot, enable, quad)
    ...
    if enable == 1
        ...
        % plot the reference coordinate 
        plot3([0 s/4], [0 0], [0 0], 'LineWidth', 2, 'Color', 'r')
        plot3([0 0], -[0 s/4], [0 0], 'LineWidth', 2, 'Color', 'g')
        plot3([0 0], [0 0], -[0 s/4], 'LineWidth', 2, 'Color', 'b')
        ...
        py = z + 1.0*d*ey;
        pz = z + 1.0*d*ez;
        plot3([z(1) px(1)], -[z(2) px(2)], -[z(3) px(3)], 'LineWidth', 1, 'Color', 'r')
        plot3([z(1) py(1)], -[z(2) py(2)], -[z(3) py(3)], 'LineWidth', 1, 'Color', 'g')
        plot3([z(1) pz(1)], -[z(2) pz(2)], -[z(3) pz(3)], 'LineWidth', 1, 'Color', 'b')
